(function() {
    ...
    function Autoplay({swiper: swiper, extendParams: extendParams, on: on, emit: emit}) {
        let timeout;
        swiper.autoplay = {
            running: false,
            paused: false
    ...
    function initSliders() {
        if (document.querySelector(".swiper-info-block")) new core(".swiper-info-block", {
